...
function readPackageJSON(widgetStructure) {
    return __awaiter(this, void 0, void 0, function* () {
...
function buildWidget() {
    return action_awaiter(this, void 0, void 0, function* () {
        ...
        console.log(`Building widget in folder: ${WIDGET_FOLDER}`);
        console.log(`Building widget in path: ${WIDGET_FOLDER_PATH}`);
        ...
        // Reads package.json
        const packageJSON = yield readPackageJSON(widgetFolderStructure);
        ...
        const buildFiles = yield findBuildFiles(FOLDER_WHERE_RELEASE_IS);
